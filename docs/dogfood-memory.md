...
- Use explicit recall only when the user asks or when doing a visible preflight.
...
node dist/cli.js index --root .dogfood-memory # maintenance: rebuild after generated/manual Markdown changes
